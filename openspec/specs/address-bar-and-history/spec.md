# address-bar-and-history Specification

## Purpose
Path navigation: breadcrumb display, editable-text mode with a fixed parse pipeline, invalid/inaccessible path feedback, per-context back/forward history, and drive/volume selection.
