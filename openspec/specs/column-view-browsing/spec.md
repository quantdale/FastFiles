# column-view-browsing Specification

## Purpose
The primary browsing surface: adjacent columns each showing one level of the filesystem hierarchy, with visible selection state, horizontal scrolling for deep hierarchies, and in-place handling of inaccessible or vanished directories.
