# file-operations-core Specification

## Purpose
The file-operation execution path: STA worker-thread IFileOperation execution for copy/move/rename/create/delete, batch progress and cancellation, per-item failure isolation, Recycle-Bin default deletion, explicitly confirmed permanent deletion, and session undo history.
