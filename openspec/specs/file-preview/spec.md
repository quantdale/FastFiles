...
## Purpose
The preview pane: registry-based provider selection, WIC image and text previews, graceful fallback for unsupported types, and previews that always track the current single selection.
