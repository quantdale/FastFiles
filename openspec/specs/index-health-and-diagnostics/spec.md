# index-health-and-diagnostics Specification

## Purpose
Index transparency and control: per-volume status derivation with fixed precedence, diagnostic logging that never contains file content, redacted bundle export, pause/resume/enable/disable indexing, and adding newly detected volumes.
