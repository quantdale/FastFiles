...
## Purpose
The shortcut model: default bindings, Global vs Active-View scopes, search-hotkey priority, persisted customization data, conflict detection, and reserved-key warnings.
