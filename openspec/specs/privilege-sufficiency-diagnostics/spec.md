# privilege-sufficiency-diagnostics Specification

## Purpose
Observational diagnostics at the real scan call site: token privilege capture, distinguishable failure classification, evidence that persists beyond the process, and no behavior change while diagnostics are inert.
