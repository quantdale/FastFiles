# storage-drilldown-and-treemap Specification

## Purpose
Hierarchical storage analysis: percentage-context drill-down, largest folders/files views, sorting, an interactive squarified treemap with hover metadata and click-to-navigate, calculating states, partial-coverage labeling, and strict non-destructiveness.
