# storage-overview Specification

## Purpose
Per-volume capacity summary sourced from OS reporting, drive selection into detailed analysis, degraded-mode availability, and indexed-coverage indication.
