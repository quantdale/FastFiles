# ui-appearance Specification

## Purpose
The modernized visual layer: unified Fluent-style design tokens, real system icons, gated non-blocking animation, restyled column view, modernized search surface, theme-coherent Win32 chrome and dialogs, modern window chrome, device-loss recovery, and file-operation progress in the status bar.
